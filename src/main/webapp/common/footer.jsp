	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
				<h3 class="footer-heading mb-4">Store</h3>
				<a href="#" class="block-6"> <img src="images/lg-milano.jpg"
			...
			<div class="col-md-6 col-lg-3">
				<div class="block-5 mb-5">
					...
					<ul class="list-unstyled">
						<li class="address">Tòa nhà QTSC9 (toà T), đường Tô Ký,
							phường Tân Chánh Hiệp, quận 12, TP HCM</li>
						<li class="phone"><a href="tel://23923929210">+2 392 3929
								210</a></li>
						<li class="email">Coffee Da Nham</li>
					</ul>
				</div>
